...
CREATE TABLE films_characters(
    ...
    PRIMARY KEY(film_id ASC, people_id ASC)
);
...
CREATE TABLE planets(
	...
	rotation_period text NULL,
	surface_water text NULL,
	terrain text NULL,
    PRIMARY KEY CLUSTERED (id ASC)
);
CREATE TABLE species(
	id int NOT NULL,
	average_height text NULL,
	average_lifespan text NULL,
	classification text NULL,
	created nvarchar(100) NULL,
	designation text NULL,
	edited nvarchar(100) NULL,
	eye_colors text NULL,
	hair_colors text NULL,
	homeworld int NULL,
	language text NULL,
	name text NULL,
	skin_colors text NULL,
    PRIMARY KEY CLUSTERED (id ASC) 
);
...
CREATE TABLE starships(
	id int NOT NULL,
	MGLT text NULL,
	hyperdrive_rating text NULL,
	starship_class text NULL,
...
CREATE TABLE transports(
	id int NOT NULL,
	cargo_capacity text NULL,
	consumables text NULL,
	cost_in_credits text NULL,
	created nvarchar(100) NULL,
	crew text NULL,
	edited nvarchar(100) NULL,
	length text NULL,
	manufacturer text NULL,
	10000_atmosphering_speed text NULL,
	model text NULL,
	name text NULL,
...
INSERT INTO films (created, director, edited, episode_id, id, opening_crawl, producer, release_date, title)
    VALUES
        (N'2014-12-19', N'George Lucas', N'2014-12-20', 1, 4, N'Turmoil has engulfed the
...
INSERT INTO films (created, director, edited, episode_id, id, opening_crawl, producer, release_date, title)
    VALUES
        (N'2014-12-10', N'George Lucas', N'2014-12-20', 4, 1, N'It is a period of civil war.
...
INSERT INTO films (created, director, edited, episode_id, id, opening_crawl, producer, release_date, title)
    VALUES
        (N'2014-12-12', N'Irvin Kershner', N'2014-12-15', 5, 2, N'It is a dark time for the
...
INSERT INTO films (created, director, edited, episode_id, id, opening_crawl, producer, release_date, title)
    VALUES
        (N'2014-12-18', N'Richard Marquand', N'2014-12-20', 6, 3, N'Luke Skywalker has returned to
...
INSERT INTO films (created, director, edited, episode_id, id, opening_crawl, producer, release_date, title)
    VALUES
        (N'2014-12-20', N'George Lucas', N'2014-12-20', 2, 5, N'There is unrest in the Galactic
...
INSERT INTO films (created, director, edited, episode_id, id, opening_crawl, producer, release_date, title)
    VALUES
        (N'2014-12-20', N'George Lucas', N'2014-12-20', 3, 6, N'War! The Republic is crumbling
...
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
        (N'41.9BBY', N'2014-12-10T15:18:20.704Z', N'2014-12-20', N'yellow', N'male', N'none', N'202', 1, 4, N'136', N'Darth Vader', N'white');
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
        (N'19BBY', N'2014-12-09T13:50:51.644Z', N'2014-12-20', N'blue', N'male', N'blond', N'172', 1, 1, N'77', N'Luke Skywalker', N'fair');
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
        (N'19BBY', N'2014-12-10T15:20:09.791Z', N'2014-12-20', N'brown', N'female', N'brown', N'150', 2, 5, N'49', N'Leia Organa', N'light');
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
        (N'52BBY', N'2014-12-10T15:52:14.024Z', N'2014-12-20', N'blue', N'male', N'brown, grey', N'178', 1, 6, N'120', N'Owen Lars', N'light');
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
        (N'47BBY', N'2014-12-10T15:53:41.121Z', N'2014-12-20', N'blue', N'female', N'brown', N'165', 1, 7, N'75', N'Beru Whitesun lars', N'light');
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
...
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
        (N'46BBY', N'2014-12-19T17:28:26.926Z', N'2014-12-20T21:17:50.381Z', N'brown', N'female', N'brown', N'185', 8, 35, N'45', N'Padm� Amidala', N'light');
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
...
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
        (N'unknown', N'2014-12-19T17:45:01.522Z', N'2014-12-20T21:17:50.392Z', N'blue', N'male', N'brown', N'183', 8, 39, N'unknown', N'Ric Oli�', N'fair');
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
...
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
        (N'unknown', N'2014-12-20T11:11:39.630Z', N'2014-12-20T21:17:50.449Z', N'brown', N'female', N'brown', N'157', 8, 61, N'unknown', N'Cord�', N'light');
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
...
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
        (N'unknown', N'2014-12-20T16:49:14.640Z', N'2014-12-20T21:17:50.460Z', N'brown', N'female', N'brown', N'165', 8, 66, N'unknown', N'Dorm�', N'light');
INSERT INTO people (birth_year, created, edited, eye_color, gender, hair_color, height, homeworld, id, mass, name, skin_color)
    VALUES
...
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
        (N'temperate', N'2014-12-10T11:52:31.066Z', N'12120', N'2014-12-20T20:58:18.430Z', N'1 standard', 8, N'Naboo', N'312', N'41000000000', N'26', N'12', N'grassy hills, swamps, forests, mountains');
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
...
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
        (N'temperate, arid, windy', N'2014-12-10T12:49:01.491Z', N'12900', N'2014-12-20T20:58:18.439Z', N'1 standard', 12, N'Utapau', N'351', N'910000000', N'27', N'0.9', N'scrublands, savanna, canyons, sinkholes');
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
...
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
        (N'tropical', N'2014-12-10T13:32:00.124Z', N'12765', N'2014-12-20T20:58:18.442Z', N'1 standard', 14, N'Kashyyyk', N'381', N'410000000', N'26', N'60', N'jungle, forests, lakes, rivers');
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
...
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
        (N'hot, humid', N'2014-12-10T13:44:50.397Z', N'9100', N'2014-12-20T20:58:18.447Z', N'0.75 standard', 17, N'Felucia', N'231', N'81000000', N'34', N'unknown', N'fungus forests');
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
...
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
        (N'superheated', N'2014-12-18T11:25:40.243Z', N'12780', N'2014-12-20T20:58:18.474Z', N'1', 33, N'Sullust', N'263', N'181000000000', N'20', N'5', N'mountains, volcanoes, rocky deserts');
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
...
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
        (N'temperate, arid, subartic', N'2014-12-20T09:46:25.740Z', N'10600', N'2014-12-20T20:58:18.481Z', N'1', 37, N'Ryloth', N'305', N'11000000000', N'30', N'5', N'mountains, valleys, deserts, tundra');
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
...
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
        (N'temperate', N'2014-12-20T10:14:48.178Z', N'unknown', N'2014-12-20T20:58:18.493Z', N'1', 43, N'Cerea', N'386', N'4100000000', N'27', N'20', N'verdant');
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
...
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
        (N'tropical, temperate', N'2014-12-20T10:18:26.110Z', N'15600', N'2014-12-20T20:58:18.495Z', N'1', 44, N'Glee Anselm', N'206', N'1000000000', N'33', N'80', N'lakes, islands, swamps, seas');
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
...
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
        (N'temperate', N'2014-12-20T10:52:51.524Z', N'unknown', N'2014-12-20T20:58:18.506Z', N'1', 50, N'Champala', N'318', N'31000000000', N'27', N'unknown', N'oceans, rainforests, plateaus');
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
...
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
        (N'frigid', N'2014-12-20T17:27:41.286Z', N'unknown', N'2014-12-20T20:58:18.516Z', N'unknown', 55, N'Ojom', N'unknown', N'1000000000', N'unknown', N'100', N'oceans, glaciers');
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
        (N'temperate', N'2014-12-20T17:57:47.420Z', N'13800', N'2014-12-20T20:58:18.519Z', N'1', 57, N'Muunilinst', N'412', N'10000000000', N'28', N'25', N'plains, forests, hills, mountains');
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
...
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
        (N'temperate', N'2014-12-20T17:50:47.864Z', N'unknown', N'2014-12-20T20:58:18.517Z', N'1', 56, N'Skako', N'384', N'1000000000000', N'27', N'unknown', N'urban, vines');
INSERT INTO planets (climate, created, diameter, edited, gravity, id, name, orbital_period, population, rotation_period, surface_water, terrain)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'3000000', N'1 year', N'31000000', N'2014-12-10T14:20:33.369Z', N'30-165', N'2014-12-20T21:23:49.867Z', 2, N'150', N'Corellian Engineering Corporation', N'950', N'CR90 corvette', N'CR90 corvette', N'600');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'36000000', N'2 years', N'1100000000', N'2014-12-10T15:08:19.848Z', N'47,060', N'2014-12-20T21:23:49.870Z', 3, N'1,600', N'Kuat Drive Yards', N'975', N'Imperial I-class Star Destroyer', N'Star Destroyer', N'n/a');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'100000', N'2 months', N'1100000', N'2014-12-10T15:36:25.724Z', N'46', N'2014-12-20T21:30:21.661Z', 4, N'36.8 ', N'Corellia Mining Corporation', N'30', N'Digger Crawler', N'Sand Crawler', N'30');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'2100000000', N'6 years', N'11433100000', N'2014-12-15T12:31:42.547Z', N'279,144', N'2014-12-20T21:23:49.893Z', 15, N'19000', N'Kuat Drive Yards, Fondor Shipyards', N'n/a', N'Executor-class star dreadnought', N'Executor', N'38000');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'10', N'1 day', N'710000', N'2014-12-15T12:58:50.530Z', N'2', N'2014-12-20T21:30:21.681Z', 20, N'7', N'Bespin Motors', N'1500', N'Storm IV Twin-Pod', N'Storm IV Twin-Pod cloud car', N'0');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'6000000', N'2 years', N'81000000', N'2014-12-15T13:06:30.813Z', N'854', N'2014-12-20T21:23:49.902Z', 23, N'300', N'Kuat Drive Yards', N'800', N'EF76 Nebulon-B escort frigate', N'EF76 Nebulon-B escort frigate', N'75');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'1310000', N'1 day', N'8000', N'2014-12-18T10:48:03.208Z', N'5', N'2014-12-20T21:30:21.688Z', 25, N'9.5', N'Ubrikkian Industries', N'250', N'Bantha-II', N'Bantha-II cargo skiff', N'16');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'40', N'1 week', N'1710000', N'2014-12-18T11:16:34.542Z', N'1', N'2014-12-20T21:23:49.907Z', 28, N'9.6', N'Alliance Underground Engineering, Incom Corporation', N'1300', N'RZ-1 A-wing Interceptor', N'A-wing', N'0');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'2000000', N'Live food tanks', N'2810000', N'2014-12-18T10:44:14.217Z', N'26', N'2014-12-20T21:30:21.684Z', 24, N'30', N'Ubrikkian Industries Custom Vehicle Division', N'100', N'Modified Luxury Sail Barge', N'Sail barge', N'500');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'21000000', N'30 days', N'510000000', N'2014-12-20T09:39:56.116Z', N'1', N'2014-12-20T21:23:49.922Z', 41, N'26.5', N'Republic Sienar Systems', N'1180', N'Star Courier', N'Scimitar', N'6');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'112100000', N'2 years', N'unknown', N'2014-12-20T18:08:42.926Z', N'700', N'2014-12-20T21:23:49.935Z', 52, N'752', N'Rothana Heavy Engineering', N'unknown', N'Acclamator I-class assault ship', N'Republic Assault ship', N'16000');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'100000000', N'4 years', N'1210000000', N'2014-12-20T19:40:21.902Z', N'600', N'2014-12-20T21:23:49.941Z', 59, N'1088', N'Rendili StarDrive, Free Dac Volunteers Engineering corps.', N'1050', N'Providence-class carrier/destroyer', N'Trade Federation cruiser', N'48247');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'100000', N'56 days', N'1000000', N'2014-12-20T19:48:40.409Z', N'5', N'2014-12-20T21:23:49.944Z', 61, N'18.5', N'Cygnus Spaceworks', N'2000', N'Theta-class T-2c shuttle', N'Theta-class T-2c shuttle', N'16');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'110', N'5 days', N'1510000', N'2014-12-20T20:03:48.603Z', N'3', N'2014-12-20T21:23:49.953Z', 66, N'14.5', N'Incom Corporation, Subpro Corporation', N'1000', N'Aggressive Reconnaissance-170 starfighte', N'arc-170', N'0');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'10', N'none', N'110000', N'2014-12-20T19:43:54.870Z', N'1', N'2014-12-20T21:30:21.745Z', 60, N'3.5', N'Z-Gomot Ternbuell Guppat Corporation', N'330', N'Tsmeu-6 personal wheel bike', N'Tsmeu-6 personal wheel bike', N'1');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
        (N'30000', N'20 days', N'3100000', N'2014-12-20T20:24:45.587Z', N'20', N'2014-12-20T21:30:21.762Z', 71, N'49.4', N'Kuat Drive Yards', N'160', N'HAVw A6 Juggernaut', N'Clone turbo tank', N'300');
INSERT INTO transports (cargo_capacity, consumables, cost_in_credits, created, crew, edited, id, length, manufacturer, 10000_atmosphering_speed, model, name, passengers)
    VALUES
...
INSERT films_characters (film_id, people_id) VALUES (4, 2);
INSERT films_characters (film_id, people_id) VALUES (4, 3);
INSERT films_characters (film_id, people_id) VALUES (4, 10);
INSERT films_characters (film_id, people_id) VALUES (4, 11);
INSERT films_characters (film_id, people_id) VALUES (4, 16);
INSERT films_characters (film_id, people_id) VALUES (4, 20);
INSERT films_characters (film_id, people_id) VALUES (4, 21);
INSERT films_characters (film_id, people_id) VALUES (4, 32);
INSERT films_characters (film_id, people_id) VALUES (4, 33);
INSERT films_characters (film_id, people_id) VALUES (4, 34);
INSERT films_characters (film_id, people_id) VALUES (4, 35);
INSERT films_characters (film_id, people_id) VALUES (4, 36);
INSERT films_characters (film_id, people_id) VALUES (4, 37);
INSERT films_characters (film_id, people_id) VALUES (4, 38);
INSERT films_characters (film_id, people_id) VALUES (4, 39);
INSERT films_characters (film_id, people_id) VALUES (4, 40);
INSERT films_characters (film_id, people_id) VALUES (4, 41);
INSERT films_characters (film_id, people_id) VALUES (4, 42);
INSERT films_characters (film_id, people_id) VALUES (4, 43);
INSERT films_characters (film_id, people_id) VALUES (4, 44);
INSERT films_characters (film_id, people_id) VALUES (4, 46);
INSERT films_characters (film_id, people_id) VALUES (4, 47);
INSERT films_characters (film_id, people_id) VALUES (4, 48);
INSERT films_characters (film_id, people_id) VALUES (4, 49);
INSERT films_characters (film_id, people_id) VALUES (4, 50);
INSERT films_characters (film_id, people_id) VALUES (4, 51);
INSERT films_characters (film_id, people_id) VALUES (4, 52);
INSERT films_characters (film_id, people_id) VALUES (4, 53);
INSERT films_characters (film_id, people_id) VALUES (4, 54);
INSERT films_characters (film_id, people_id) VALUES (4, 55);
INSERT films_characters (film_id, people_id) VALUES (4, 56);
INSERT films_characters (film_id, people_id) VALUES (4, 57);
INSERT films_characters (film_id, people_id) VALUES (4, 58);
INSERT films_characters (film_id, people_id) VALUES (4, 59);

INSERT films_characters (film_id, people_id) VALUES (1, 1);
INSERT films_characters (film_id, people_id) VALUES (1, 2);
INSERT films_characters (film_id, people_id) VALUES (1, 3);
INSERT films_characters (film_id, people_id) VALUES (1, 4);
INSERT films_characters (film_id, people_id) VALUES (1, 5);
INSERT films_characters (film_id, people_id) VALUES (1, 6);
INSERT films_characters (film_id, people_id) VALUES (1, 7);
INSERT films_characters (film_id, people_id) VALUES (1, 8);
INSERT films_characters (film_id, people_id) VALUES (1, 9);
INSERT films_characters (film_id, people_id) VALUES (1, 10);
INSERT films_characters (film_id, people_id) VALUES (1, 12);
INSERT films_characters (film_id, people_id) VALUES (1, 13);
INSERT films_characters (film_id, people_id) VALUES (1, 14);
INSERT films_characters (film_id, people_id) VALUES (1, 15);
INSERT films_characters (film_id, people_id) VALUES (1, 16);
INSERT films_characters (film_id, people_id) VALUES (1, 18);
INSERT films_characters (film_id, people_id) VALUES (1, 19);
INSERT films_characters (film_id, people_id) VALUES (1, 81);

INSERT films_characters (film_id, people_id) VALUES (2, 1);
INSERT films_characters (film_id, people_id) VALUES (2, 2);
INSERT films_characters (film_id, people_id) VALUES (2, 3);
INSERT films_characters (film_id, people_id) VALUES (2, 4);
INSERT films_characters (film_id, people_id) VALUES (2, 5);
INSERT films_characters (film_id, people_id) VALUES (2, 10);
INSERT films_characters (film_id, people_id) VALUES (2, 13);
INSERT films_characters (film_id, people_id) VALUES (2, 14);
INSERT films_characters (film_id, people_id) VALUES (2, 18);
INSERT films_characters (film_id, people_id) VALUES (2, 20);
INSERT films_characters (film_id, people_id) VALUES (2, 21);
INSERT films_characters (film_id, people_id) VALUES (2, 22);
INSERT films_characters (film_id, people_id) VALUES (2, 23);
INSERT films_characters (film_id, people_id) VALUES (2, 24);
INSERT films_characters (film_id, people_id) VALUES (2, 25);
INSERT films_characters (film_id, people_id) VALUES (2, 26);
INSERT films_characters (film_id, people_id) VALUES (3, 1);
INSERT films_characters (film_id, people_id) VALUES (3, 2);
INSERT films_characters (film_id, people_id) VALUES (3, 3);
INSERT films_characters (film_id, people_id) VALUES (3, 4);
INSERT films_characters (film_id, people_id) VALUES (3, 5);
INSERT films_characters (film_id, people_id) VALUES (3, 10);
INSERT films_characters (film_id, people_id) VALUES (3, 13);
INSERT films_characters (film_id, people_id) VALUES (3, 14);
INSERT films_characters (film_id, people_id) VALUES (3, 16);
INSERT films_characters (film_id, people_id) VALUES (3, 18);
INSERT films_characters (film_id, people_id) VALUES (3, 20);
INSERT films_characters (film_id, people_id) VALUES (3, 21);
INSERT films_characters (film_id, people_id) VALUES (3, 22);
INSERT films_characters (film_id, people_id) VALUES (3, 25);
INSERT films_characters (film_id, people_id) VALUES (3, 27);
INSERT films_characters (film_id, people_id) VALUES (3, 28);
INSERT films_characters (film_id, people_id) VALUES (3, 29);
INSERT films_characters (film_id, people_id) VALUES (3, 30);
INSERT films_characters (film_id, people_id) VALUES (3, 31);
INSERT films_characters (film_id, people_id) VALUES (3, 45);

INSERT films_characters (film_id, people_id) VALUES (5, 2);
INSERT films_characters (film_id, people_id) VALUES (5, 3);
INSERT films_characters (film_id, people_id) VALUES (5, 6);
INSERT films_characters (film_id, people_id) VALUES (5, 7);
INSERT films_characters (film_id, people_id) VALUES (5, 10);
INSERT films_characters (film_id, people_id) VALUES (5, 11);
INSERT films_characters (film_id, people_id) VALUES (5, 20);
INSERT films_characters (film_id, people_id) VALUES (5, 21);
INSERT films_characters (film_id, people_id) VALUES (5, 22);
INSERT films_characters (film_id, people_id) VALUES (5, 33);
INSERT films_characters (film_id, people_id) VALUES (5, 35);
INSERT films_characters (film_id, people_id) VALUES (5, 36);
INSERT films_characters (film_id, people_id) VALUES (5, 40);
INSERT films_characters (film_id, people_id) VALUES (5, 43);
INSERT films_characters (film_id, people_id) VALUES (5, 46);
INSERT films_characters (film_id, people_id) VALUES (5, 51);
INSERT films_characters (film_id, people_id) VALUES (5, 52);
INSERT films_characters (film_id, people_id) VALUES (5, 53);
INSERT films_characters (film_id, people_id) VALUES (5, 58);
INSERT films_characters (film_id, people_id) VALUES (5, 59);
INSERT films_characters (film_id, people_id) VALUES (5, 60);
INSERT films_characters (film_id, people_id) VALUES (5, 61);
INSERT films_characters (film_id, people_id) VALUES (5, 62);
INSERT films_characters (film_id, people_id) VALUES (5, 63);
INSERT films_characters (film_id, people_id) VALUES (5, 64);
INSERT films_characters (film_id, people_id) VALUES (5, 65);
INSERT films_characters (film_id, people_id) VALUES (5, 66);
INSERT films_characters (film_id, people_id) VALUES (5, 67);
INSERT films_characters (film_id, people_id) VALUES (5, 68);
INSERT films_characters (film_id, people_id) VALUES (5, 69);
INSERT films_characters (film_id, people_id) VALUES (5, 70);
INSERT films_characters (film_id, people_id) VALUES (5, 71);
INSERT films_characters (film_id, people_id) VALUES (5, 72);
INSERT films_characters (film_id, people_id) VALUES (5, 73);
INSERT films_characters (film_id, people_id) VALUES (5, 74);
INSERT films_characters (film_id, people_id) VALUES (5, 75);
INSERT films_characters (film_id, people_id) VALUES (5, 76);
INSERT films_characters (film_id, people_id) VALUES (5, 77);
INSERT films_characters (film_id, people_id) VALUES (5, 78);
INSERT films_characters (film_id, people_id) VALUES (5, 82);

INSERT films_characters (film_id, people_id) VALUES (6, 1);
INSERT films_characters (film_id, people_id) VALUES (6, 2);
INSERT films_characters (film_id, people_id) VALUES (6, 3);
INSERT films_characters (film_id, people_id) VALUES (6, 4);
INSERT films_characters (film_id, people_id) VALUES (6, 5);
INSERT films_characters (film_id, people_id) VALUES (6, 6);
INSERT films_characters (film_id, people_id) VALUES (6, 7);
INSERT films_characters (film_id, people_id) VALUES (6, 10);
INSERT films_characters (film_id, people_id) VALUES (6, 11);
INSERT films_characters (film_id, people_id) VALUES (6, 12);
INSERT films_characters (film_id, people_id) VALUES (6, 13);
INSERT films_characters (film_id, people_id) VALUES (6, 20);
INSERT films_characters (film_id, people_id) VALUES (6, 21);
INSERT films_characters (film_id, people_id) VALUES (6, 33);
INSERT films_characters (film_id, people_id) VALUES (6, 35);
INSERT films_characters (film_id, people_id) VALUES (6, 46);
INSERT films_characters (film_id, people_id) VALUES (6, 51);
INSERT films_characters (film_id, people_id) VALUES (6, 52);
INSERT films_characters (film_id, people_id) VALUES (6, 53);
INSERT films_characters (film_id, people_id) VALUES (6, 54);
INSERT films_characters (film_id, people_id) VALUES (6, 55);
INSERT films_characters (film_id, people_id) VALUES (6, 56);
INSERT films_characters (film_id, people_id) VALUES (6, 58);
INSERT films_characters (film_id, people_id) VALUES (6, 63);
INSERT films_characters (film_id, people_id) VALUES (6, 64);
INSERT films_characters (film_id, people_id) VALUES (6, 67);
INSERT films_characters (film_id, people_id) VALUES (6, 68);
INSERT films_characters (film_id, people_id) VALUES (6, 75);
INSERT films_characters (film_id, people_id) VALUES (6, 78);
INSERT films_characters (film_id, people_id) VALUES (6, 79);
INSERT films_characters (film_id, people_id) VALUES (6, 80);
INSERT films_characters (film_id, people_id) VALUES (6, 81);
INSERT films_characters (film_id, people_id) VALUES (6, 82);
INSERT films_characters (film_id, people_id) VALUES (6, 83);

INSERT films_planets (film_id, planet_id) VALUES (4, 1);
INSERT films_planets (film_id, planet_id) VALUES (4, 8);
INSERT films_planets (film_id, planet_id) VALUES (4, 9);
INSERT films_planets (film_id, planet_id) VALUES (1, 1);
INSERT films_planets (film_id, planet_id) VALUES (1, 2);
INSERT films_planets (film_id, planet_id) VALUES (1, 3);
INSERT films_planets (film_id, planet_id) VALUES (2, 4);
INSERT films_planets (film_id, planet_id) VALUES (2, 5);
INSERT films_planets (film_id, planet_id) VALUES (2, 6);
INSERT films_planets (film_id, planet_id) VALUES (2, 27);
INSERT films_planets (film_id, planet_id) VALUES (3, 1);
INSERT films_planets (film_id, planet_id) VALUES (3, 5);
INSERT films_planets (film_id, planet_id) VALUES (3, 7);
INSERT films_planets (film_id, planet_id) VALUES (3, 8);
INSERT films_planets (film_id, planet_id) VALUES (3, 9);
INSERT films_planets (film_id, planet_id) VALUES (5, 1);
INSERT films_planets (film_id, planet_id) VALUES (5, 8);
INSERT films_planets (film_id, planet_id) VALUES (5, 9);
INSERT films_planets (film_id, planet_id) VALUES (5, 10);
INSERT films_planets (film_id, planet_id) VALUES (5, 11);
INSERT films_planets (film_id, planet_id) VALUES (6, 1);
INSERT films_planets (film_id, planet_id) VALUES (6, 2);
INSERT films_planets (film_id, planet_id) VALUES (6, 5);
INSERT films_planets (film_id, planet_id) VALUES (6, 8);
INSERT films_planets (film_id, planet_id) VALUES (6, 9);
INSERT films_planets (film_id, planet_id) VALUES (6, 12);
INSERT films_planets (film_id, planet_id) VALUES (6, 13);
INSERT films_planets (film_id, planet_id) VALUES (6, 14);
INSERT films_planets (film_id, planet_id) VALUES (6, 15);
INSERT films_planets (film_id, planet_id) VALUES (6, 16);
INSERT films_planets (film_id, planet_id) VALUES (6, 17);
INSERT films_planets (film_id, planet_id) VALUES (6, 18);
INSERT films_planets (film_id, planet_id) VALUES (6, 19);
INSERT films_species (film_id, species_id) VALUES (4, 1);
INSERT films_species (film_id, species_id) VALUES (4, 2);
INSERT films_species (film_id, species_id) VALUES (4, 6);
INSERT films_species (film_id, species_id) VALUES (4, 11);
INSERT films_species (film_id, species_id) VALUES (4, 12);
INSERT films_species (film_id, species_id) VALUES (4, 13);
INSERT films_species (film_id, species_id) VALUES (4, 14);
INSERT films_species (film_id, species_id) VALUES (4, 15);
INSERT films_species (film_id, species_id) VALUES (4, 16);
INSERT films_species (film_id, species_id) VALUES (4, 17);
INSERT films_species (film_id, species_id) VALUES (4, 18);
INSERT films_species (film_id, species_id) VALUES (4, 19);
INSERT films_species (film_id, species_id) VALUES (4, 20);
INSERT films_species (film_id, species_id) VALUES (4, 21);
INSERT films_species (film_id, species_id) VALUES (4, 22);
INSERT films_species (film_id, species_id) VALUES (4, 23);
INSERT films_species (film_id, species_id) VALUES (4, 24);
INSERT films_species (film_id, species_id) VALUES (4, 25);
INSERT films_species (film_id, species_id) VALUES (4, 26);
INSERT films_species (film_id, species_id) VALUES (4, 27);
INSERT films_species (film_id, species_id) VALUES (1, 1);
INSERT films_species (film_id, species_id) VALUES (1, 2);
INSERT films_species (film_id, species_id) VALUES (1, 3);
INSERT films_species (film_id, species_id) VALUES (1, 4);
INSERT films_species (film_id, species_id) VALUES (1, 5);
INSERT films_species (film_id, species_id) VALUES (2, 1);
INSERT films_species (film_id, species_id) VALUES (2, 2);
INSERT films_species (film_id, species_id) VALUES (2, 3);
INSERT films_species (film_id, species_id) VALUES (2, 6);
INSERT films_species (film_id, species_id) VALUES (2, 7);
INSERT films_species (film_id, species_id) VALUES (3, 1);
INSERT films_species (film_id, species_id) VALUES (3, 2);
INSERT films_species (film_id, species_id) VALUES (3, 3);
INSERT films_species (film_id, species_id) VALUES (3, 5);
INSERT films_species (film_id, species_id) VALUES (3, 6);
INSERT films_species (film_id, species_id) VALUES (3, 8);
INSERT films_species (film_id, species_id) VALUES (3, 9);
INSERT films_species (film_id, species_id) VALUES (3, 10);
INSERT films_species (film_id, species_id) VALUES (3, 15);
INSERT films_species (film_id, species_id) VALUES (5, 1);
INSERT films_species (film_id, species_id) VALUES (5, 2);
INSERT films_species (film_id, species_id) VALUES (5, 6);
INSERT films_species (film_id, species_id) VALUES (5, 12);
INSERT films_species (film_id, species_id) VALUES (5, 13);
INSERT films_species (film_id, species_id) VALUES (5, 15);
INSERT films_species (film_id, species_id) VALUES (5, 28);
INSERT films_species (film_id, species_id) VALUES (5, 29);
INSERT films_species (film_id, species_id) VALUES (5, 30);
INSERT films_species (film_id, species_id) VALUES (5, 31);
INSERT films_species (film_id, species_id) VALUES (5, 32);
INSERT films_species (film_id, species_id) VALUES (5, 33);
INSERT films_species (film_id, species_id) VALUES (5, 34);
INSERT films_species (film_id, species_id) VALUES (5, 35);
INSERT films_species (film_id, species_id) VALUES (6, 1);
INSERT films_species (film_id, species_id) VALUES (6, 2);
INSERT films_species (film_id, species_id) VALUES (6, 3);
INSERT films_species (film_id, species_id) VALUES (6, 6);
INSERT films_species (film_id, species_id) VALUES (6, 15);
INSERT films_species (film_id, species_id) VALUES (6, 19);
INSERT films_species (film_id, species_id) VALUES (6, 20);
INSERT films_species (film_id, species_id) VALUES (6, 23);
INSERT films_species (film_id, species_id) VALUES (6, 24);
INSERT films_species (film_id, species_id) VALUES (6, 25);
INSERT films_species (film_id, species_id) VALUES (6, 26);
INSERT films_species (film_id, species_id) VALUES (6, 27);
INSERT films_species (film_id, species_id) VALUES (6, 28);
INSERT films_species (film_id, species_id) VALUES (6, 29);
INSERT films_species (film_id, species_id) VALUES (6, 30);
INSERT films_species (film_id, species_id) VALUES (6, 33);
INSERT films_species (film_id, species_id) VALUES (6, 34);
INSERT films_species (film_id, species_id) VALUES (6, 35);
INSERT films_species (film_id, species_id) VALUES (6, 36);
INSERT films_species (film_id, species_id) VALUES (6, 37);
INSERT films_starships (film_id, starship_id) VALUES (4, 31);
INSERT films_starships (film_id, starship_id) VALUES (4, 32);
INSERT films_starships (film_id, starship_id) VALUES (4, 39);
INSERT films_starships (film_id, starship_id) VALUES (4, 40);
INSERT films_starships (film_id, starship_id) VALUES (4, 41);
INSERT films_starships (film_id, starship_id) VALUES (1, 2);
INSERT films_starships (film_id, starship_id) VALUES (1, 3);
INSERT films_starships (film_id, starship_id) VALUES (1, 5);
INSERT films_starships (film_id, starship_id) VALUES (1, 9);
INSERT films_starships (film_id, starship_id) VALUES (1, 10);
INSERT films_starships (film_id, starship_id) VALUES (1, 11);
INSERT films_starships (film_id, starship_id) VALUES (1, 12);
INSERT films_starships (film_id, starship_id) VALUES (1, 13);
INSERT films_starships (film_id, starship_id) VALUES (2, 3);
INSERT films_starships (film_id, starship_id) VALUES (2, 10);
INSERT films_starships (film_id, starship_id) VALUES (2, 11);
INSERT films_starships (film_id, starship_id) VALUES (2, 12);
INSERT films_starships (film_id, starship_id) VALUES (2, 15);
INSERT films_starships (film_id, starship_id) VALUES (2, 17);
INSERT films_starships (film_id, starship_id) VALUES (2, 21);
INSERT films_starships (film_id, starship_id) VALUES (2, 22);
INSERT films_starships (film_id, starship_id) VALUES (2, 23);
INSERT films_starships (film_id, starship_id) VALUES (3, 2);
INSERT films_starships (film_id, starship_id) VALUES (3, 3);
INSERT films_starships (film_id, starship_id) VALUES (3, 10);
INSERT films_starships (film_id, starship_id) VALUES (3, 11);
INSERT films_starships (film_id, starship_id) VALUES (3, 12);
INSERT films_starships (film_id, starship_id) VALUES (3, 15);
INSERT films_starships (film_id, starship_id) VALUES (3, 17);
INSERT films_starships (film_id, starship_id) VALUES (3, 22);
INSERT films_starships (film_id, starship_id) VALUES (3, 23);
INSERT films_starships (film_id, starship_id) VALUES (3, 27);
INSERT films_starships (film_id, starship_id) VALUES (3, 28);
INSERT films_starships (film_id, starship_id) VALUES (3, 29);
INSERT films_starships (film_id, starship_id) VALUES (5, 21);
INSERT films_starships (film_id, starship_id) VALUES (5, 32);
INSERT films_starships (film_id, starship_id) VALUES (5, 39);
INSERT films_starships (film_id, starship_id) VALUES (5, 43);
INSERT films_starships (film_id, starship_id) VALUES (5, 47);
INSERT films_starships (film_id, starship_id) VALUES (5, 48);
INSERT films_starships (film_id, starship_id) VALUES (5, 49);
INSERT films_starships (film_id, starship_id) VALUES (5, 52);
INSERT films_starships (film_id, starship_id) VALUES (5, 58);
INSERT films_starships (film_id, starship_id) VALUES (6, 2);
INSERT films_starships (film_id, starship_id) VALUES (6, 32);
INSERT films_starships (film_id, starship_id) VALUES (6, 48);
INSERT films_starships (film_id, starship_id) VALUES (6, 59);
INSERT films_starships (film_id, starship_id) VALUES (6, 61);
INSERT films_starships (film_id, starship_id) VALUES (6, 63);
INSERT films_starships (film_id, starship_id) VALUES (6, 64);
INSERT films_starships (film_id, starship_id) VALUES (6, 65);
INSERT films_starships (film_id, starship_id) VALUES (6, 66);
INSERT films_starships (film_id, starship_id) VALUES (6, 68);
INSERT films_starships (film_id, starship_id) VALUES (6, 74);
INSERT films_starships (film_id, starship_id) VALUES (6, 75);
INSERT films_vehicles (film_id, vehicle_id) VALUES (4, 33);
INSERT films_vehicles (film_id, vehicle_id) VALUES (4, 34);
INSERT films_vehicles (film_id, vehicle_id) VALUES (4, 35);
INSERT films_vehicles (film_id, vehicle_id) VALUES (4, 36);
INSERT films_vehicles (film_id, vehicle_id) VALUES (4, 37);
INSERT films_vehicles (film_id, vehicle_id) VALUES (4, 38);
INSERT films_vehicles (film_id, vehicle_id) VALUES (4, 42);
INSERT films_vehicles (film_id, vehicle_id) VALUES (1, 4);
INSERT films_vehicles (film_id, vehicle_id) VALUES (1, 6);
INSERT films_vehicles (film_id, vehicle_id) VALUES (1, 7);
INSERT films_vehicles (film_id, vehicle_id) VALUES (1, 8);
INSERT films_vehicles (film_id, vehicle_id) VALUES (2, 8);
INSERT films_vehicles (film_id, vehicle_id) VALUES (2, 14);
INSERT films_vehicles (film_id, vehicle_id) VALUES (2, 16);
INSERT films_vehicles (film_id, vehicle_id) VALUES (2, 18);
INSERT films_vehicles (film_id, vehicle_id) VALUES (2, 19);
INSERT films_vehicles (film_id, vehicle_id) VALUES (2, 20);
INSERT films_vehicles (film_id, vehicle_id) VALUES (3, 8);
INSERT films_vehicles (film_id, vehicle_id) VALUES (3, 16);
INSERT films_vehicles (film_id, vehicle_id) VALUES (3, 18);
INSERT films_vehicles (film_id, vehicle_id) VALUES (3, 19);
INSERT films_vehicles (film_id, vehicle_id) VALUES (3, 24);
INSERT films_vehicles (film_id, vehicle_id) VALUES (3, 25);
INSERT films_vehicles (film_id, vehicle_id) VALUES (3, 26);
INSERT films_vehicles (film_id, vehicle_id) VALUES (3, 30);
INSERT films_vehicles (film_id, vehicle_id) VALUES (5, 4);
INSERT films_vehicles (film_id, vehicle_id) VALUES (5, 44);
INSERT films_vehicles (film_id, vehicle_id) VALUES (5, 45);
INSERT films_vehicles (film_id, vehicle_id) VALUES (5, 46);
INSERT films_vehicles (film_id, vehicle_id) VALUES (5, 50);
INSERT films_vehicles (film_id, vehicle_id) VALUES (5, 51);
INSERT films_vehicles (film_id, vehicle_id) VALUES (5, 53);
INSERT films_vehicles (film_id, vehicle_id) VALUES (5, 54);
INSERT films_vehicles (film_id, vehicle_id) VALUES (5, 55);
INSERT films_vehicles (film_id, vehicle_id) VALUES (5, 56);
INSERT films_vehicles (film_id, vehicle_id) VALUES (5, 57);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 33);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 50);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 53);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 56);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 60);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 62);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 67);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 69);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 70);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 71);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 72);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 73);
INSERT films_vehicles (film_id, vehicle_id) VALUES (6, 76);

INSERT species_people (species_id, people_id) VALUES (1, 66);
INSERT species_people (species_id, people_id) VALUES (1, 67);
INSERT species_people (species_id, people_id) VALUES (1, 68);
INSERT species_people (species_id, people_id) VALUES (1, 74);
INSERT species_people (species_id, people_id) VALUES (4, 15);
INSERT species_people (species_id, people_id) VALUES (5, 16);
INSERT species_people (species_id, people_id) VALUES (6, 20);
INSERT species_people (species_id, people_id) VALUES (8, 27);
INSERT species_people (species_id, people_id) VALUES (7, 24);
INSERT species_people (species_id, people_id) VALUES (9, 30);
INSERT species_people (species_id, people_id) VALUES (3, 13);
INSERT species_people (species_id, people_id) VALUES (3, 80);
INSERT species_people (species_id, people_id) VALUES (2, 2);
INSERT species_people (species_id, people_id) VALUES (2, 3);
INSERT species_people (species_id, people_id) VALUES (2, 8);
INSERT species_people (species_id, people_id) VALUES (2, 23);
INSERT species_people (species_id, people_id) VALUES (11, 33);
INSERT species_people (species_id, people_id) VALUES (13, 40);
INSERT species_people (species_id, people_id) VALUES (14, 41);
INSERT species_people (species_id, people_id) VALUES (16, 47);
INSERT species_people (species_id, people_id) VALUES (15, 45);
INSERT species_people (species_id, people_id) VALUES (15, 46);
INSERT species_people (species_id, people_id) VALUES (10, 31);
INSERT species_people (species_id, people_id) VALUES (17, 48);
INSERT species_people (species_id, people_id) VALUES (19, 50);
INSERT species_people (species_id, people_id) VALUES (12, 36);
INSERT species_people (species_id, people_id) VALUES (12, 37);
INSERT species_people (species_id, people_id) VALUES (12, 38);
INSERT species_people (species_id, people_id) VALUES (20, 52);
INSERT species_people (species_id, people_id) VALUES (18, 49);
INSERT species_people (species_id, people_id) VALUES (21, 53);
INSERT species_people (species_id, people_id) VALUES (22, 44);
INSERT species_people (species_id, people_id) VALUES (22, 54);
INSERT species_people (species_id, people_id) VALUES (23, 55);
INSERT species_people (species_id, people_id) VALUES (24, 56);
INSERT species_people (species_id, people_id) VALUES (25, 57);
INSERT species_people (species_id, people_id) VALUES (26, 58);
INSERT species_people (species_id, people_id) VALUES (28, 63);
INSERT species_people (species_id, people_id) VALUES (27, 59);
INSERT species_people (species_id, people_id) VALUES (31, 71);
INSERT species_people (species_id, people_id) VALUES (30, 70);
INSERT species_people (species_id, people_id) VALUES (32, 72);
INSERT species_people (species_id, people_id) VALUES (32, 73);
INSERT species_people (species_id, people_id) VALUES (29, 64);
INSERT species_people (species_id, people_id) VALUES (29, 65);
INSERT species_people (species_id, people_id) VALUES (34, 77);
INSERT species_people (species_id, people_id) VALUES (33, 76);
INSERT species_people (species_id, people_id) VALUES (35, 78);
INSERT species_people (species_id, people_id) VALUES (36, 79);
INSERT species_people (species_id, people_id) VALUES (37, 83);
INSERT starships_pilots (starship_id, people_id) VALUES (10, 13);
INSERT starships_pilots (starship_id, people_id) VALUES (10, 14);
INSERT starships_pilots (starship_id, people_id) VALUES (10, 25);
INSERT starships_pilots (starship_id, people_id) VALUES (10, 31);
INSERT starships_pilots (starship_id, people_id) VALUES (12, 1);
INSERT starships_pilots (starship_id, people_id) VALUES (12, 9);
INSERT starships_pilots (starship_id, people_id) VALUES (12, 18);
INSERT starships_pilots (starship_id, people_id) VALUES (12, 19);
INSERT starships_pilots (starship_id, people_id) VALUES (13, 4);
INSERT starships_pilots (starship_id, people_id) VALUES (21, 22);
INSERT starships_pilots (starship_id, people_id) VALUES (22, 1);
INSERT starships_pilots (starship_id, people_id) VALUES (22, 13);
INSERT starships_pilots (starship_id, people_id) VALUES (22, 14);
INSERT starships_pilots (starship_id, people_id) VALUES (28, 29);
INSERT starships_pilots (starship_id, people_id) VALUES (39, 11);
INSERT starships_pilots (starship_id, people_id) VALUES (39, 35);
INSERT starships_pilots (starship_id, people_id) VALUES (39, 60);
INSERT starships_pilots (starship_id, people_id) VALUES (40, 39);
INSERT starships_pilots (starship_id, people_id) VALUES (41, 44);
INSERT starships_pilots (starship_id, people_id) VALUES (48, 10);
INSERT starships_pilots (starship_id, people_id) VALUES (48, 58);
INSERT starships_pilots (starship_id, people_id) VALUES (49, 35);
INSERT starships_pilots (starship_id, people_id) VALUES (59, 10);
INSERT starships_pilots (starship_id, people_id) VALUES (59, 11);
INSERT starships_pilots (starship_id, people_id) VALUES (64, 10);
INSERT starships_pilots (starship_id, people_id) VALUES (64, 35);
INSERT starships_pilots (starship_id, people_id) VALUES (65, 10);
INSERT starships_pilots (starship_id, people_id) VALUES (65, 11);
INSERT starships_pilots (starship_id, people_id) VALUES (74, 10);
INSERT starships_pilots (starship_id, people_id) VALUES (74, 79);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (14, 1);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (14, 18);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (19, 13);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (30, 1);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (30, 5);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (38, 10);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (38, 32);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (44, 11);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (42, 44);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (45, 70);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (46, 11);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (55, 67);
INSERT vehicles_pilots (vehicle_id, people_id) VALUES (60, 79);
